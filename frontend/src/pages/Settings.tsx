...
const maintenance = {
  thumbnails: {
    ...
    description:
      "Clear cached media and face thumbnails. This does not remove original files or face identities. Previews may need to be regenerated by a scan.",
        ...
        <aside className="settings-secondary">
          ...
          <section className="maintenance-card">
            ...
            {Object.entries(maintenance).map(([key, item]) => (
              <button
                key={key}
                className={`button ${key !== "thumbnails" ? "danger-text" : ""}`}
                disabled={active}
